...
var media = Object.keys(config.breakpoints).reduce(function (media, breakpoint, index) {
  media[breakpoint] = index === 0 ? function () {
    return styled.css(_templateObject, styled.css.apply(undefined, arguments));
  } : function () {
    return styled.css(_templateObject2, config.viewport[breakpoint], styled.css.apply(undefined, arguments));
  };
  return media;
}, {});
...
var Container = styled__default.div(_templateObject2$1, config.halfGutterWidth, config.halfGutterWidth, function (props) {
...
var Row = styled__default.div(_templateObject$2, config.gutterCompensation, config.gutterCompensation, function (props) {
...
var Col = styled__default.div(_templateObject4$1, config.halfGutterWidth, config.halfGutterWidth, function (props) {
